  ...
  return (
    <section id="about">
      <div className="about__text">
        ...
        <p>
          Apasionado por el conocimiento y entusiasta de la tecnología. Tengo
          experiencia en el desarrollo de aplicaciones web y mobile de la mano
          de Javascript usando React y Native para el Frontend y Node para el
          Backend.
        </p>
        <p>
          Siempre estoy buscando aprender nueva habilidades, asumir
          responsabilidades y crecer profesionalmente.
        </p>
        <p>Estas son algunas de las teclonologías con las que he trabajado.</p>
      ...
      <div className="about__model">
        <img alt="model" src="/images/abuot.png" />
      </div>
    </section>
  );
};
